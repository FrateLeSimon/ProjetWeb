...
<html>
    ...
    <body>
      ...
      <section class="popup">
        ...
        <h1>Le projet : </h1>
        <p>Aujourd'hui, les étudiants effectuent leurs recherches de stage en entreprise en activant leurs réseaux personnels et professionnels (LinkedIn, anciennes promotions, etc.), en postulant à des offres.
